...
function($, _, Backbone, hogan, WysiwymTextarea) {
/*----------------------------------------------------------------------------------------------
...
//var Wysiwym = {};
  ...
  var wysiwym = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      this.dispatcher.on('insertMarkdown', this.onInsertMarkdown, this);
    },
    ...
    onInsertMarkdown: function(callback) {
    ...
    span: function(data) {
      ...
      var suffix = data.suffix;    // (required) Text wrap suffix
      var text = data.text;        // (required) Default wrap text (if nothing selected)
